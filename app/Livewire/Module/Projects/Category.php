...
class Category extends Component
{
    ...
    public function render()
    {
        ...
        $data = ProjectCategory::where('category_name', 'LIKE', $search)
            ->orderBy('id', 'ASC')
            ->paginate($this->lengthData);

        return view('livewire.module.projects.category', compact('data'));
    }
    ...
    {
        ProjectCategory::findOrFail($this->dataId)->delete();
