                ...
                <form>
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div wire:ignore>
                                        <select wire:model="sub_category_id" id="sub_category_id"
                                            class="form-control" multiple>
                                            <option value="" disabled>-- Select Sub Category --</option>
                                            @foreach ($subcategories as $subcategory)
                                                <option value="{{ $subcategory['id'] }}"
                                                    @if (in_array($subcategory['id'], $sub_category_id)) selected @endif>
                        ...
                        <div class="form-group">
                            ...
                            <div wire:ignore>
                                <textarea wire:model="description" id="description" class="form-control" style="height: 75px"></textarea>
                            </div>
                            @error('description')
                                <small class='text-danger'>{{ $message }}</small>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div wire:ignore>
                                <textarea wire:model="fill_content" id="fill_content" class="form-control" style="height: 75px"></textarea>
                            </div>
                            @error('fill_content')
                                <small class='text-danger'>{{ $message }}</small>
                            @enderror
            ...
            $(document).ready(function() {
                ...
                subcategories.forEach(function(subcategory) {
                    ...
                    select.append('<option value="' + subcategory.id + '" ' + selected + '>' +
                        subcategory.nama_sub_kategori + '</option>');
                });
