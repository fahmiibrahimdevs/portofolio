            ...
            <div class="tw-container tw-max-w-2xl tw-mx-auto tw-text-left">
                            ...
                            @foreach ($row as $item)
                                <a href="{{ url('articles/' . $item['sub_category_name']) }}">
                                    <div
                                        ...
                                        <img src="{{ asset('/icons/' . $item['image']) }}"
                ...
                @else
                    <div class="tw-text-center">
                        ...
                        <p class="tw-mt-5 tw-mb-16 tw-font-medium">Articles, tutorials, and topics about what you're looking for.</p>
                    </div>
                    ...
                    @empty
                        <div
                            ...
                            <h2 class="tw-text-sm lg:tw-text-base tw-text-gray-400">Currently, we don't have articles in this category.</h2>
                        </div>
                    @endforelse
