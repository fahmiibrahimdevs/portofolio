            ...
            <nav class="navbar navbar-secondary navbar-expand-lg">
                <div class="container">
                    <ul class="navbar-nav" style="margin-top: 0px">
                        ...
                        <li
                            class="nav-item dropdown {{ request()->is('module/articles/category') || request()->is('module/articles/sub-category') || request()->is('module/articles/posts') ? 'active' : '' }}">
                            <a href="#" data-toggle="dropdown" class="nav-link has-dropdown">
                                <i class="far fa-blog"></i><span>Articles</span>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="nav-item {{ request()->is('module/articles/category') ? 'active' : '' }}">
                                    <a href="/module/articles/category" class="nav-link">Category</a>
                                </li>
                                <li
                                    class="nav-item {{ request()->is('module/articles/sub-category') ? 'active' : '' }}">
                                    <a href="/module/articles/sub-category" class="nav-link">Sub-Category</a>
                                </li>
                                <li class="nav-item {{ request()->is('module/articles/posts') ? 'active' : '' }}">
                                    <a href="/module/articles/posts" class="nav-link">Posts</a>
                                </li>
                            </ul>
                        </li>
                        <li
                        ...
                        <li
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item {{ request()->is('module/keagamaan/kategori') ? 'active' : '' }}">
                                ...
                                <li class="nav-item {{ request()->is('module/keagamaan/postingan') ? 'active' : '' }}">
                        ...
                        <li
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item {{ request()->is('module/perkuliahan/semester') ? 'active' : '' }}">
                                    <a href="/module/perkuliahan/semester" class="nav-link">Semester</a>
                                </li>
                                <li class="nav-item {{ request()->is('module/perkuliahan/dosen') ? 'active' : '' }}">
                                ...
                                <li class="nav-item {{ request()->is('module/perkuliahan/jadwal') ? 'active' : '' }}">
                                    <a href="/module/perkuliahan/jadwal" class="nav-link">Jadwal</a>
                                </li>
                                <li class="nav-item {{ request()->is('module/perkuliahan/catatan') ? 'active' : '' }}">
                                    <a href="/module/perkuliahan/catatan" class="nav-link">Catatan</a>
                                </li>
                                <li class="nav-item {{ request()->is('module/perkuliahan/tugas') ? 'active' : '' }}">
                                    <a href="/module/perkuliahan/tugas" class="nav-link">Tugas</a>
                                </li>
                                <li class="nav-item {{ request()->is('module/perkuliahan/cloud') ? 'active' : '' }}">
                                    <a href="/module/perkuliahan/cloud" class="nav-link">Cloud</a>
                                </li>
                                <li class="nav-item {{ request()->is('module/perkuliahan/ppkp') ? 'active' : '' }}">
